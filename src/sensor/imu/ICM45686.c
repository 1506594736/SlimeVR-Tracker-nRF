...
//	err |= ssi_burst_write(SENSOR_INTERFACE_DEV_IMU, ICM45686_IREG_ADDR_15_8, ireg_buf, 3); // write buffer
	...
	ireg_buf[2] = 0x10; // set wake thresholds // 10 x 3.9 mg is ~39.00 mg
	ireg_buf[3] = 0x10; // set wake thresholds
	ireg_buf[4] = 0x10; // set wake thresholds
