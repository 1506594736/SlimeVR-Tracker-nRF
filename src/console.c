...
#if DT_NODE_HAS_STATUS(DT_NODELABEL(mag), okay) || DT_NODE_HAS_STATUS(DT_NODELABEL(mag_spi), okay)                     \
	|| DT_NODE_HAS_STATUS(DT_NODELABEL(imu), okay) || DT_NODE_HAS_STATUS(DT_NODELABEL(imu_spi), okay)
